namespace Redcat.Xmpp.Xml
{
    public static class Namespaces
    {
        ...
        public static readonly string JabberClient = "jabber:client";
        public static readonly string JabberServer = "jabber:server";
        public static readonly string Roster = "jabber:iq:roster";
        public static readonly string RosterVersion = "urn:xmpp:features:rosterver";
        ...
        public static readonly string Streams = "http://etherx.jabber.org/streams";
